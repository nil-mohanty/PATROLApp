...
public class BroadcastGenUserActivity extends AppCompatActivity {
    ...
    private String TAG = "Broadcast Gen USer Activity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_broadcast_gen_user_display);
